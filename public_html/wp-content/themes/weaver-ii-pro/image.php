...
?>
		<div id="container_wrap"<?php weaverii_get_page_class('image'); ?>>
...
<?php		weaverii_get_sidebar_top('image'); ?>
			...
			<nav id="nav-above">
				<h3 class="assistive-text"><?php _e( 'Image navigation','weaver-ii'); ?></h3>
					...
					<header class="entry-header">
						...
						<div class="entry-meta">
							<?php
								...
								printf( __( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><abbr class="published" title="%1$s">%2$s</abbr></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%7$s</a>','weaver-ii'),
...
?>
								...
								$attachment_size = apply_filters( 'weaverii_attachment_size', 848 );
