...
?>
		<div id="container_wrap"<?php weaverii_get_page_class('search'); ?>>
...
<?php		weaverii_get_sidebar_top('search'); ?>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php weaverii_content_nav( 'nav-below', true ); ?>
			...
			<?php else : ?>
				...
				<article id="post-0" class="post no-results not-found">
					...
					<div class="entry-content">
						<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.','weaver-ii'); ?></p>
						<?php get_search_form(); ?>
					</div><!-- .entry-content -->
				</article><!-- #post-0 -->
