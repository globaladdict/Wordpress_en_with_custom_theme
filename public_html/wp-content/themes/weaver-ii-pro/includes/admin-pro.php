...
function weaverii_admin_pro() {
	...
	'info' => 'Show a 1px red border around most major &ltdiv&gts. Overrides other borders. &diams;'),
    ...
    array('name' => '<small>Show Mobile Device Info</small>', 'id' => '_wii_diag_trace_mobile', 'type' => '+checkbox',
    ...
    array('name' => 'Disable Show/Hide Text', 'id' => '_wii_hide_showhide', 'type' => '+checkbox',
	  'info' => 'Show/Hide - [weaver_show_hide] - adds button to show/hide text such as lyrics or spoilers &diams;'),
...
<p>
<a title="Weaver II Pro Premium Theme" href="http://pro.weavertheme.com" target="_blank">
...
<br /></br />
<strong>Visit <a title="Weaver II Pro Premium Theme" href="http://pro.weavertheme.com" target="_blank">pro.WeaverTheme.com</a>
