...
<small><strong>Media Library Picker Tool:</strong></small>&nbsp;<input name="wii_media_url" type="text" style="width:400px;height:22px;" class="regular-text" name="wii_media_url"
    ...
    <p>You will notice
    <?php weaverii_help_link('help.html#top', __('Weaver II Help', 'weaver-ii'/*a*/ )); ?>
...
Section</a></li>
      ...
      <li><a href=\"$readme#File_access_plugin\" target=\"_blank\">Weaver File Access Plugin</a></li>
