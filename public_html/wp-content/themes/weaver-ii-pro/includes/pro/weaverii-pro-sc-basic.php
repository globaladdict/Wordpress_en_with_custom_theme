...
<p>
<em>[weaver_show_posts cats="" tags="" author="" single_post="" post_type='' orderby="date" sort="DESC" number="5" show="full" hide_title=""
...
?>
<p>The <code>[weaver_breadcumbs]</code> shortcode allows you display "breadcrumbs" to the current page. This is the same
...
links on blog pages. This is the same
...
<?php weaverii_help_link('help.html#sitetitlesc','Help for Weaver Site Title and Description');
?>
<br />
<label><span style="color:blue;font-weight:bold; font-size: larger;"><b>Site Description - [weaver_site_desc]</b></span></label>

<p>The <code>[weaver_site_title]</code> and <code>[weaver_site_desc]</code> shortcodes allow you display the current
site title and site description. This can be useful in a text widget in the Header Widget Area, for example.</p>
...
<h4>Vimeo</h4>
<pre><strong>[weaver_vimeo vimeo-url id=videoid sd=0 percent=100 ratio=.5625 center=1 color=#hex autoplay=0 loop=0 portrait=1 title=1 byline=1]
</strong></pre>
...
<h4>YouTube</h4>
<pre><strong>[weaver_youtube youtube-url id=videoid sd=0 percent=100 ratio=.5625 center=1 rel=0 https=0 privacy=0  see_help_for_others]
</strong></pre>
...
<p>You bracket the content you want to selectively display with <code>[weaver_show_if_logged_in] or [weaver_show_hide_if_logged_in]</code> and closing
<code>[/weaver_show_if_logged_in]</code> or tags
<code>[/weaver_show_if_logged_in]</code>. That content can contain other shortcodes as needed. </p>
...
<p><strong>Shortcode usage:</strong> <code>[wevaer_html html-tag args='parameters']</code>
<br />
<ol>
